""" This program attempts to solve the TSP with the use of the Hill Climbing algorithm
    ...
    The solution is attempted by interchanging 1  set of indexes and seeing if the situation 
    is improved. The more iterations run, the better the solution gets.
